...
import type { ROOM_TYPE } from 'src/types/room';
              ...
              <div className='m-w-72 h-52 rounded-lg bg-blue-300 p-4 flex flex-col justify-between' key={i}>
                <div className='number_house'>
                  <p className='text-base text-gray-500'>
                    <i className='fa-solid fa-house'></i> <span>{item.numberHouse}</span>
                  </p>
                </div>
                ...
                <div>
                  ...
                  <span className='text-green-600 font-bold'>{item.member}</span>
                  <br />
                  <i className='fa-solid fa-money-bill text-gray-500'></i>{' '}
                  <span className='text-red-500 font-semibold'>{item.priceRoom}</span>
                </div>
