...
const FormCreateRoom = () => {
    ...
    return (
        <div className='mt-8'>
            <form action="">
                <div className='lg:flex justify-between items-center gap-8 py-3 md:justify-start gap-8'>
                    <label htmlFor="" className='w-64 text-base font-semibold'>Phòng số</label>
                    <div className='w-full'>
                        <input className='w-full border-2 p-4 outline-0 md: my-3' type="text" placeholder='Phòng số' />
                    </div>
                    <label htmlFor="" className="w-64 text-base font-semibold">Nhà</label>
                    <div className='w-full'>
                        <select className='w-full border-2 p-4 outline-0 md: my-3' name="" id="">
                ...
                <div className='lg:flex justify-between items-center gap-12 py-3 md:justify-start gap-8'>
                    <label htmlFor="" className='w-64 text-base font-semibold'>Số lượng người tối đa</label>
                    <div className='w-full'>
                        <input className='w-full border-2 p-4 outline-0 md: my-3' type="number" placeholder='Số lượng người tối đa' />
                    </div>
                    <label htmlFor="" className="w-64 text-base font-semibold">Đơn giá</label>
                    <div className='w-full'>
                        <input className='w-full border-2 p-4 outline-0 md: my-3' type="number" placeholder='Đơn giá' />
                    </div>
                </div>
                <div className='lg:flex justify-between items-center gap-12 py-3 md:justify-start gap-8'>
                    <label htmlFor="" className='w-64 text-base font-semibold'>Dài</label>
                    <div className='w-full'>
                        <input className='w-full border-2 p-4 outline-0 md: my-3' type="number" placeholder='Chiều dài phòng' />
                    </div>
                    <label htmlFor="" className="w-64 text-base font-semibold">Rộng</label>
                    <div className='w-full'>
                        <input className='w-full border-2 p-4 outline-0 md: my-3' type="number" placeholder='Chiều rộng phòng' />
                    </div>
                </div>
                <div className='lg:flex justify-between items-center gap-12 py-3 md:justify-start gap-8'>
