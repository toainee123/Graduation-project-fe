...
const Homepage = () => {
  return (
    <>
      <header className='sticky top-0 bg-slate-200 z-50'>
        <div className='container mx-auto flex items-center py-4'>
          <div className='py-1'>
            <h1>Bee Home</h1>
          </div>
          <ul className='hidden sm:flex flex-1 justify-end items-center gap-12 text-bookmark-blue uppercase text-xs'>
            <li className='cursor-pointer text-lg font-semibold link link-underline link-underline-black'>
              Giới thiệu
            </li>
            <li className='cursor-pointer text-lg font-semibold link link-underline link-underline-black'>Báo cáo</li>
            <li className='cursor-pointer text-lg font-semibold link link-underline link-underline-black'>Liên hệ</li>
            <Link to={'/auth'}>
              <button className='rounded-lg font-medium text-lg px-4 py-2 border-2 border-white text-black hover:bg-black hover:text-white duration-300'>
                Đăng nhập
              </button>
            </Link>
          </ul>
        ...
        <div data-aos='fade-up' className='bg-slate-200 py-3'>
          ...
          <div className='relative mt-10 lg:mt-20'>
            <div className='container mx-auto flex flex-col lg:flex-row justify-center gap-x-24'>
              ...
              <div className='flex flex-1 flex-col items-center lg:items-start'>
                <h1 className='text-3xl text-bookmark-blue'>Tính năng cơ bản</h1>
                <ul className='list-disc ml-8'>
                  <li className='py-3 text-xl'>Nhập chỉ số điện, nước, dịch vụ; tính tiền phòng</li>
                ...
                <button className='rounded-lg px-4 py-2 border-2 border-purple-500 text-blue-500 hover:bg-purple-500 hover:text-white duration-300'>
                  Xem thêm
                </button>
              </div>
            </div>
      ...
      <section>
        <div
          data-aos='fade-up'
          className='p-6 container mx-auto md:w-2/3 xl:w-auto mx-auto  flex flex-col xl:items-stretch justify-between xl:flex-row'
        >
